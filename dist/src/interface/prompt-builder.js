 ...
 */
function buildCapabilitiesSection(skills) {
    if (skills.length === 0) {
        return `## Capabilities
 ...
 */
function buildContextSection(timezone) {
    const now = new Date();
 ...
 */
function buildGuidelinesSection(channel) {
    switch (channel) {
        case 'imessage':
 ...
 */
export function buildIMessagePrompt(skills, workspacePath) {
